...
namespace DbMetaTool
{
    public static class Program
    {
        ...
        public static void BuildDatabase(string databaseDirectory, string scriptsDirectory)
        {
            ...
            var dbPath = dbManager.CreateDatabase(databaseDirectory);

            dbManager.ExecuteDatabaseScriptsWithDatabasePath(dbPath, scriptsDirectory);
        }
        ...
        public static void ExportScripts(string connectionString, string outputDirectory)
        {
            ...
            IScriptExporter scriptExporter = new ScriptExporter(metadataReader, fileManager);

            scriptExporter.GenerateDatabaseScripts(connectionString, outputDirectory, ScriptFormat.Sql);
        }
        ...
        public static void UpdateDatabase(string connectionString, string scriptsDirectory)
        {
            ...
            dbManager.ExecuteDatabaseScriptsWithConnectionString(connectionString, scriptsDirectory);
        }
    }
}